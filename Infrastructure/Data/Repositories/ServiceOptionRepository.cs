...
public class ServiceOptionRepository : IServiceOptionRepository
{
    ...
    public async Task<int> AddServiceOptionAsync(string name, string? description, int? categoryId)
    {
        ...
        const string sql =
            ...
            IF NOT EXISTS (
                SELECT 1 FROM dbo.VehicleTypeServiceOption
                WHERE VehicleTypeId = 3 AND ServiceOptionId = @ServiceOptionId
            )
            BEGIN
    ...
    public async Task<int> AddParentServiceOptionAsync(int optionId, int parentId)
    {
        ...
        const string sql =
            ...
            WHERE NOT EXISTS (
                SELECT 1 FROM dbo.ServiceOptionRelation
    ...
    public async Task<int> AddServiceOptionServiceTypeAsync(string optionId, string serviceTypeId)
    {
        ...
        const string sql =
            ...
            WHERE NOT EXISTS (
                SELECT 1 FROM dbo.ServiceOptionServiceType
                WHERE ServiceOptionId = @OptionId AND ServiceTypeId = @ServiceTypeId
            );";
    ...
    private static async Task<List<FlatServiceOption>> QueryFlatOptions(SqlConnection conn, string sql)
    {
        ...
        {
            results.Add(new FlatServiceOption
            {
